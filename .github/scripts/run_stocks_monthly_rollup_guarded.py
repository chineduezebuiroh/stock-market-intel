...
def run_profile() -> None:
    ...
    results = []
    results += run_combo_health(combos=["stocks_a_mqy_shortlist"], universe="shortlist_stocks.csv")
    results += run_combo_health(combos=["stocks_a_mqy_all"], universe="options_eligible.csv")
