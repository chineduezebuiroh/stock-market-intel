...
def run_profile() -> None:
    ...
    notify_combo_signals("stocks_a_mqy_shortlist", only_if_changed=False, route="stocks_monthly")
    notify_combo_signals("stocks_a_mqy_all", only_if_changed=False, route="stocks_monthly")
